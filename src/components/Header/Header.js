    ...
    <header>
      <div className="container">
        ...
        <div className="socialicons">
          <a className="icons" href="https://github.com/MahfujSajib" target="_blank "><BsLinkedin></BsLinkedin></a>
          <a className="icons" href="https://github.com/MahfujSajib" target="_blank"><BsGithub></BsGithub></a>
